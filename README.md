## This repository is archived in favour of custom component version of Watchman, it's available here: https://github.com/dummylabs/thewatchman 
...
`excluded_folders` | False | Deprecated, use `ignored_files` instead. List of folders to exclude from the scan. Takes precedence over `included_folders`. | `None` 
...
### Additional notification service parameters in watchman.yaml
